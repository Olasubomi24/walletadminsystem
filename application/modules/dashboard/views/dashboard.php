        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Dashboard</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Wallet
                                System</a></li>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?= number_format($main_account, 2) ?></h5>
                                                <span><i class="zmdi zmdi-balance"></i> Main Account</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?= number_format($yesterday_revenue, 2) ?></h5>
                                                <span><i class="zmdi zmdi-turning-sign"></i> Yesterday Revenue</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?= number_format($today_revenue, 2) ?></h5>
                                                <span><i class="zmdi zmdi-turning-sign"></i> Today Revenue</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?= number_format($weekly_revenue, 2) ?></h5>
                                                <span><i class="zmdi zmdi-turning-sign"></i> Weekly Revenue</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?= number_format($month_revenue, 2) ?></h5>
                                                <span><i class="zmdi zmdi-turning-sign"></i> Month Revenue</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="state_w1 mb-1 mt-1">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h5><?= number_format($year_revenue, 2) ?></h5>
                                                <span><i class="zmdi zmdi-turning-sign"></i> Year Revenue</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
